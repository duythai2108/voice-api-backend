...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasPostgresEnum(null, "JobStatus", new[] { "pending", "processing", "finished" })
            ...
            modelBuilder.Entity("VoiceAPI.Entities.Candidate", b =>
                {
                    ...
                    b.Property<List<string>>("VoiceLinks")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("VoiceAPI.Entities.JobInvitation", b =>
                {
                    b.HasOne("VoiceAPI.Entities.Candidate", "Candidate")
                        ...
                        .HasForeignKey("VoiceAPI.Entities.JobInvitation", "CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
